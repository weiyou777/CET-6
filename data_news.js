  ...
  "reading": [
    {
      ...
      "y": "2026·时事",
      "title": "国产 AI 算力与产业落地",
      "skillNote": "时事阅读：细节定位+数字+观点，素材来自 2026 世界人工智能大会",
      ...
      "questions": [
        {
          "q": "What can be learned about the 2026 World Artificial Intelligence Conference?",
          "opts": [
            "It was held in Beijing with 300 exhibitors.",
            "Over 300 exhibits made their global debut out of 4,000-plus.",
            "Intended purchases fell by 25% year on year.",
            "Only domestic companies participated."
          ],
          "a": 1,
          "skill": "细节-数字",
          "ex": "原文指出 1100 余家企业展出 4000 余款展品，其中超 300 款全球首发，选B。",
          "ref": [
            "more than 1,100 companies showcased over 4,000 exhibits, with over 300 making their global debut"
          ]
        },
        {
          "q": "What is notable about Huawei's Ascend 950 super node?",
          "opts": [
            "It is the smallest AI chip ever made.",
            "It packs 1,024 AI chips as the largest super node displayed.",
            "It was developed by a foreign company.",
            "It replaced all human workers."
          ],
          "a": 1,
          "skill": "细节-特征",
          "ex": "原文说昇腾950集成1024张算力卡，为展示过的最大超节点，选B。",
          "ref": [
            "packing 1,024 AI chips, made its first public appearance as the largest super node ever displayed"
          ]
        },
        {
          "q": "What is Sugon's 'Dengfeng' cluster?",
          "opts": [
            "A small research lab.",
            "China's first fully domestic 100,000-card AI supercluster.",
            "A foreign-built computing center.",
            "A smartphone operating system."
          ],
          "a": 1,
          "skill": "细节-定义",
          "ex": "原文明确其为全国产十万卡 AI 超集群并接入国家超算互联网，选B。",
          "ref": [
            "China's first fully domestic 100,000-card AI supercluster, has been connected to the national supercomputing internet"
          ]
        },
        {
          "q": "Why is Kimi K3 significant?",
          "opts": [
            "It is the cheapest model.",
            "It has 2.8 trillion parameters as the world's largest open-source model.",
            "It replaced human researchers.",
            "It only works in China."
          ],
          "a": 1,
          "skill": "细节-数字",
          "ex": "原文指出 Kimi K3 参数 2.8 万亿，为全球最大开源模型，选B。",
          "ref": [
            "Kimi K3, with 2.8 trillion parameters, is the world's largest open-source model"
          ]
        },
        {
          "q": "According to experts, what is the real value of AI?",
          "opts": [
            "Replacing humans entirely.",
            "Empowering thousands of industries rather than replacing humans.",
            "Ending all human jobs.",
            "Only playing games."
          ],
          "a": 1,
          "skill": "态度-观点",
          "ex": "专家强调 AI 的价值在于赋能各行各业而非取代人类，选B。",
          "ref": [
            "the real value of AI lies not in replacing humans but in empowering thousands of industries"
          ]
        }
      ]
    },
    {
      ...
      "y": "2026·时事",
      "title": "非遗“出圈”与文旅消费提质",
      "skillNote": "时事阅读：细节+推理+主旨，素材来自 2026 非遗消夏购物月",
      ...
      "questions": [
        {
          "q": "How many events did the heritage shopping month launch?",
          "opts": [
            "About 300.",
            "More than 1,200.",
            "Exactly 2,000.",
          ...
          "a": 1,
          "skill": "细节-数字",
          "ex": "原文说全国推出 1200 余场活动，选B。",
          "ref": [
            "launched more than 1,200 events"
          ]
        },
        {
          "q": "What does the passage say about new cultural formats?",
          "opts": [
            "They declined by 9.6%.",
            "Their revenue grew 9.6%, outpacing the broader industry.",
            "They replaced traditional culture.",
            "They only exist online."
          ],
          "a": 1,
          "skill": "细节-数字",
          "ex": "16 个文化新业态小类营收增长 9.6%，快于整体文化产业，选B。",
          "ref": [
            "the 16 subsectors with distinctive new cultural formats reported revenue of 3.5 trillion yuan, growing 9.6%, outpacing the broader cultural industry"
          ]
        },
        {
          "q": "What shift in consumer behavior is mentioned?",
          "opts": [
            "People prefer deep experience over mere sightseeing.",
            "Everyone stays at home.",
            "Tourists avoid ancient towns.",
            "Spending is shrinking."
          ],
          "a": 0,
          "skill": "细节-同义替换",
          "ex": "原文 travelers increasingly prefer 'deep experience' over mere sightseeing，选A。",
          "ref": [
            "travelers increasingly prefer 'deep experience' over mere sightseeing"
          ]
        },
        {
          "q": "What challenge do experts point out?",
          "opts": [
            "Culture should stay in museums.",
            "Moving from 'internet fame' to 'daily consumption'.",
            "Tourism should be banned.",
            "Young people reject tradition."
          ],
          "a": 1,
          "skill": "主旨-态度",
          "ex": "专家指出的关键挑战是从网红打卡转向日常消费，选B。",
          "ref": [
            "the key challenge is moving from 'internet fame' to 'daily consumption'"
          ]
        }
      ]
    }
  ...
  "listening": [
    {
      ...
      "questions": [
        {
          "q": "How many people does the long-term care insurance program cover?",
          "opts": [
            "About 3.3 million.",
            "Nearly 300 million.",
            "Around 2 million.",
          ...
          "a": 1,
          "skill": "细节-数字",
          "ex": "新闻说长护险已覆盖近 3 亿人，选B。",
          "ref": [
            "the program had covered nearly 300 million people and benefited over 3.3 million disabled seniors"
          ]
        },
        {
          "q": "What is the 2030 target for the share of non-fossil energy?",
          "opts": [
            "17%.",
            "25%.",
            "2.8 billion kilowatts.",
            "68.7%."
          ],
          "a": 1,
          "skill": "细节-数字",
          "ex": "双碳方案目标 2030 年非化石能源占比达 25%，选B。",
          "ref": [
            "raise the share of non-fossil energy to 25%"
          ]
        },
        {
          "q": "What was China's goods trade volume in the first half of the year?",
          "opts": [
            "25.5 trillion yuan, up 16.9%.",
            "6.5 billion yuan.",
            "3.3 million people.",
            "30.4 billion yuan."
          ],
          "a": 0,
          "skill": "细节-数字",
          "ex": "上半年货物进出口 25.5 万亿元，同比+16.9%，选A。",
          "ref": [
            "China's goods imports and exports hit 25.5 trillion yuan in the first half of the year, up 16.9%"
          ]
        },
        {
          "q": "By how much did electric vehicle exports grow?",
          "opts": [
            "39%.",
            "17%.",
            "68.7%.",
          ...
          "a": 2,
          "skill": "细节-数字",
          "ex": "新闻指出电动汽车出口增长 68.7%，选C。",
          "ref": [
            "Electric vehicle exports surged 68.7%"
          ]
        }
      ]
    }
